        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUserClaims_HotelUsers_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUserLogins_HotelUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "HotelUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AspNetUserRoles_HotelUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "HotelUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUserTokens_HotelUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "HotelUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PendingRoomRequests", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoomRequestId = table.Column<int>(type: "int", nullable: true),
                    EndedRoomRequestId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.EndedRoomRequestId,
                        principalTable: "EndedRoomRequests",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Photos_PendingRoomRequests_RoomRequestId",
                        column: x => x.RoomRequestId,
                        principalTable: "PendingRoomRequests",
                        principalColumn: "Id");
                });
